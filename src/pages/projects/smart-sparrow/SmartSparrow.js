...
const title = 'NFTlanding with 3D animation';
const description =
  'In this project, I took bright modern NFTs as a basis, created a 3D model of a bird and made it animated. Unobtrusive animation and dull colours are the hallmarks of this landing page.';
const roles = [
  'UX and UI Design',
